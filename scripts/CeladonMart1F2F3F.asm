...
DynamicTMSellerConditions:
	db 1 << BIT_CASCADEBADGE ; TM01 = TM_MEGA_PUNCH (default)
	db 1 << BIT_SOULBADGE    ; TM02 = TM_RAZOR_WIND
	db -2                    ; TM03 = TM_SWORDS_DANCE ; elite 4
	db 1 << BIT_CASCADEBADGE ; TM04 = TM_WHIRLWIND
	db 1 << BIT_CASCADEBADGE ; TM05 = TM_MEGA_KICK (default)
	db 1 << BIT_VOLCANOBADGE ; TM06 = TM_TOXIC
	db 1 << BIT_CASCADEBADGE ; TM07 = TM_HORN_DRILL (default)
	db 1 << BIT_RAINBOWBADGE ; TM08 = TM_BODY_SLAM
	db 1 << BIT_CASCADEBADGE ; TM09 = TM_TAKE_DOWN (default)
	db 1 << BIT_MARSHBADGE   ; TM10 = TM_DOUBLE_EDGE
	db 1 << BIT_RAINBOWBADGE ; TM11 = TM_BUBBLEBEAM
	db 1 << BIT_CASCADEBADGE ; TM12 = TM_WATER_GUN
	db 1 << BIT_EARTHBADGE   ; TM13 = TM_ICE_BEAM
	db -2                    ; TM14 = TM_BLIZZARD ; elite 4
	db -2                    ; TM15 = TM_HYPER_BEAM ; elite 4
	db 1 << BIT_MARSHBADGE   ; TM16 = TM_PAY_DAY
	db 1 << BIT_CASCADEBADGE ; TM17 = TM_SUBMISSION (default)
	db 1 << BIT_MARSHBADGE   ; TM18 = TM_COUNTER
	db 1 << BIT_RAINBOWBADGE ; TM19 = TM_SEISMIC_TOSS
	db 1 << BIT_SOULBADGE    ; TM20 = TM_RAGE
	db 1 << BIT_EARTHBADGE   ; TM21 = TM_MEGA_DRAIN
	db -2                    ; TM22 = TM_SOLARBEAM ; elite 4
	db 1 << BIT_RAINBOWBADGE ; TM23 = TM_DRAGON_RAGE
	db 1 << BIT_VOLCANOBADGE ; TM24 = TM_THUNDERBOLT
	db -2                    ; TM25 = TM_THUNDER ; elite 4
	db -2                    ; TM26 = TM_EARTHQUAKE ; elite 4
	db -2                    ; TM27 = TM_FISSURE ; elite 4
	db 1 << BIT_RAINBOWBADGE ; TM28 = TM_DIG
	db 1 << BIT_EARTHBADGE   ; TM29 = TM_PSYCHIC_M
	db 1 << BIT_THUNDERBADGE ; TM30 = TM_TELEPORT
	db 1 << BIT_VOLCANOBADGE ; TM31 = TM_MIMIC
	db 1 << BIT_CASCADEBADGE ; TM32 = TM_DOUBLE_TEAM (default)
	db 1 << BIT_CASCADEBADGE ; TM33 = TM_REFLECT (default)
	db 1 << BIT_RAINBOWBADGE ; TM34 = TM_BIDE
	db 1 << BIT_VOLCANOBADGE ; TM35 = TM_METRONOME
	db 1 << BIT_VOLCANOBADGE ; TM36 = TM_SELFDESTRUCT
	db 1 << BIT_CASCADEBADGE ; TM37 = TM_EGG_BOMB (default)
	db -2                    ; TM38 = TM_FIRE_BLAST ; elite 4
	db 1 << BIT_SOULBADGE    ; TM39 = TM_SWIFT
	db 1 << BIT_MARSHBADGE   ; TM40 = TM_SKULL_BASH
	db 1 << BIT_VOLCANOBADGE ; TM41 = TM_SOFTBOILED
	db 1 << BIT_RAINBOWBADGE ; TM42 = TM_DREAM_EATER
	db -2                    ; TM43 = TM_SKY_ATTACK ; elite 4
	db 1 << BIT_EARTHBADGE   ; TM44 = TM_REST
	db 1 << BIT_THUNDERBADGE ; TM45 = TM_THUNDER_WAVE
	db 1 << BIT_EARTHBADGE   ; TM46 = TM_PSYWAVE
	db -2                    ; TM47 = TM_EXPLOSION ; elite 4
	db 1 << BIT_MARSHBADGE   ; TM48 = TM_ROCK_SLIDE
	db 1 << BIT_VOLCANOBADGE ; TM49 = TM_TRI_ATTACK
	db -2                    ; TM50 = TM_SUBSTITUTE ; elite 4
	db 1 << BIT_VOLCANOBADGE ; TM51 = TM_HEX
	db -1 ; end
