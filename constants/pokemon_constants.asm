...
DEF GHOST_RATICATE EQU RATICATE
DEF GHOST_PRIMEAPE EQU PRIMEAPE
DEF GHOST_JOLTEON EQU JOLTEON
DEF GHOST_NINETALES EQU NINETALES
DEF GHOST_GENGAR EQU GENGAR
