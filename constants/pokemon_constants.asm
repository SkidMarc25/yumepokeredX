...
DEF GHOST_RATICATE EQU RATICATE   ; 2F
DEF GHOST_PRIMEAPE EQU PRIMEAPE   ; 3F
DEF GHOST_JOLTEON EQU JOLTEON     ; 4F
DEF GHOST_NINETALES EQU NINETALES ; 5F
DEF GHOST_GENGAR EQU GENGAR       ; 6F
