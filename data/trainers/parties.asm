...
LoreleiData:
	...
	db $FF, 64, DEWGONG, 66, JYNX, 64, VAPOREON, 63, CLOYSTER, 65, BLASTOISE, 66, LAPRAS, 0
...
; SS Anne 2F
	...
	; new
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, SANDSHREW, 20, WARTORTLE, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, SANDSHREW, 20, IVYSAUR, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, SANDSHREW, 20, CHARMELEON, 0
; Pokémon Tower 2F
	; original
	...
	db $FF, 24, SANDSLASH, 23, TENTACOOL, 22, MACHOP, 21, KADABRA, 25, IVYSAUR, 0
...
; Route 22
	...
	; new
	db $FF, 47, PIDGEOT, 45, MACHAMP, 45, ARCANINE, 47, VICTREEBEL, 50, ALAKAZAM, 53, BLASTOISE, 0
...
Rival3Data:
	...
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, TENTACRUEL, 65, CHARIZARD, 0
