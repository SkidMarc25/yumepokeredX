...
BrockData:
	db $FF, 12, OMANYTE, 12, KABUTO, 14, ONIX, 0
...
MistyData:  ; marcelnote - adjusted
	...
	db $FF, 18, PSYDUCK, 17, HORSEA, 21, STARMIE, 0 ; new, PSYDUCK?
	db $FF, 58, SEAKING, 56, GOLDUCK, 58, DRAGONAIR, 56, SEADRA, 58, CLEFABLE, 62, STARMIE, 0 ; new rematch team ; VAPOREON if removed from Lorelei, BLASTOISE?

LtSurgeData:
	db $FF, 21, VOLTORB, 18, MAGNEMITE, 20, PORYGON, 24, RAICHU, 0
...
ErikaData:  ; marcelnote - adjusted
	...
	db $FF, 31, TANGELA, 29, WEEPINBEL, 30, BUTTERFREE 33, VILEPLUME, 0 ; new
	db $FF, 56, VICTREEBEL, 58, BUTTERFREE, 56, EXEGGUTOR, 60, TANGELA, 58, VENUSAUR, 62, VILEPLUME, 0 ; new rematch team

KogaData:  ; marcelnote - adjusted
	;db $FF, 37, KOFFING, 39, MUK, 37, KOFFING, 43, WEEZING, 0 ; original
	db $FF, 41, WEEZING, 37, SCYTHER, 39, GOLBAT, 43, MUK, 0 ; new
	db $FF, 57, WEEZING, 59, GOLBAT, 59, MUK, 61, SCYTHER, 57, TENTACRUEL, 63, VENOMOTH, 0 ; new rematch team

SabrinaData:  ; marcelnote - adjusted
	;db $FF, 38, MR_MIME, 37, MR_MIME, 38, VENOMOTH, 43, ALAKAZAM, 0 ; original
	db $FF, 40, MR_MIME, 39, EXEGGUTOR, 43, VENOMOTH, 45, ALAKAZAM, 0 ; new
	db $FF, 58, EXEGGUTOR, 58, WIGGLYTUFF, 60, MR_MIME, 58, GENGAR, 66, VENOMOTH, 62, ALAKAZAM, 0 ; new rematch team ; STARMIE?

BlaineData:  ; marcelnote - adjusted
	;db $FF, 42, GROWLITHE, 40, PONYTA, 42, RAPIDASH, 47, ARCANINE, 0 ; original
	db $FF, 44, NINETALES, 44, RAPIDASH, 47, MAGMAR, 49, ARCANINE, 0 ; new
...
; Rocket Hideout B4F
	...
	db $FF, 26, ONIX, 28, RHYHORN, 29, NIDORINO, 31, KANGASKHAN, 0 ; new
; Silph Co. 11F
	;db $FF, 37, NIDORINO, 35, KANGASKHAN, 37, RHYHORN, 41, NIDOQUEEN, 0 ; original
	db $FF, 39, NIDORINO, 41, RHYHORN, 39, KANGASKHAN, 41, TAUROS, 43, NIDOQUEEN, 0 ; new
; Viridian Gym
	;db $FF, 45, RHYHORN, 42, DUGTRIO, 44, NIDOQUEEN, 45, NIDOKING, 50, RHYDON, 0 ; original
	db $FF, 47, DUGTRIO, 49, NIDOQUEEN, 50, TAUROS, 49, NIDOKING, 52, RHYDON, 0 ; new

LoreleiData:
	db $FF, 54, DEWGONG, 53, CLOYSTER, 54, SLOWBRO, 56, JYNX, 56, LAPRAS, 0
	; marcelnote - new rematch team
	db $FF, 64, DEWGONG, 66, JYNX, 64, SLOWBRO, 63, CLOYSTER, 65, BLASTOISE, 66, LAPRAS, 0

BrunoData:
	db $FF, 53, HITMONCHAN, 55, HITMONLEE, 55, POLIWRATH, 56, GOLEM, 58, MACHAMP, 0
	; put Poliwrath in original team as in Let's Go Pikachu?
	; marcelnote - new rematch team
	db $FF, 65, HITMONCHAN, 66, PINSIR, 65, HITMONLEE, 66, POLIWRATH, 67, GOLEM, 68, MACHAMP, 0

AgathaData:
	db $FF, 56, ARBOK, 56, NINETALES, 55, PARASECT, 58, MAROWAK, 60, GENGAR, 0
	; marcelnote - new rematch team
	db $FF, 66, ARBOK, 66, NINETALES, 65, MAROWAK, 68, PARASECT, 67, HYPNO, 70, GENGAR, 0

LanceData:
	db $FF, 58, GYARADOS, 56, SEADRA, 56, ARCANINE, 60, AERODACTYL, 62, DRAGONITE, 0
	; marcelnote - new rematch team
	db $FF, 66, DRAGONITE, 68, GYARADOS, 70, SEADRA, 68, CHARIZARD, 70, AERODACTYL, 72, DRAGONITE, 0
...
; Cerulean City ; marcelnote - modified
	...
	; new
	db $FF, 18, PIDGEOTTO, 16, RATTATA, 15, SANDSHREW, 15, BELLSPROUT, 17, SQUIRTLE, 0
	db $FF, 18, PIDGEOTTO, 16, RATTATA, 15, SANDSHREW, 15, VULPIX, 17, BULBASAUR, 0
	db $FF, 18, PIDGEOTTO, 16, RATTATA, 15, SANDSHREW, 15, KRABBY, 17, CHARMANDER, 0
...
; SS Anne 2F
	...
	; new
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, SANDSHREW, 15, BELLSPROUT, 20, WARTORTLE, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, SANDSHREW, 15, VULPIX, 20, IVYSAUR, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, SANDSHREW, 15, KRABBY, 20, CHARMELEON, 0
; Pokémon Tower 2F
	; original
	...
	; new
	db $FF, 24, SANDSLASH, 23, PONYTA, 22, MACHOP, 21, KADABRA, 23, EEVEE,  25, WARTORTLE, 0
	db $FF, 24, SANDSLASH, 23, TENTACOOL, 22, MACHOP, 21, KADABRA, 23, EEVEE,  25, IVYSAUR, 0
	db $FF, 24, SANDSLASH, 23, EXEGGCUTE, 22, MACHOP, 21, KADABRA, 23, EEVEE, 25, CHARMELEON, 0
; Silph Co. 7F
	; original
	...
	; new
	db $FF, 37, PIDGEOT, 35, MAGNETON, 38, VICTREEBEL, 37, MACHOKE, 35, DODUO,  41, BLASTOISE, 0
	db $FF, 37, PIDGEOT, 35, MAGNETON, 38, NINETALES, 37, MACHOKE, 35, DODUO,  41, VENUSAUR, 0
	db $FF, 37, PIDGEOT, 35, MAGNETON, 38, KINGLER, 37, MACHOKE, 35, DODUO, 41, CHARIZARD, 0
; Route 22
	; original
	...
	; new
	db $FF, 47, PIDGEOT, 45, MACHAMP, 45, RAPIDASH, 47, VICTREEBEL, 50, ALAKAZAM, 53, BLASTOISE, 0
	db $FF, 47, PIDGEOT, 45, MACHAMP, 45, TENTACRUEL, 47, NINETALES, 50, ALAKAZAM, 53, VENUSAUR, 0
	db $FF, 47, PIDGEOT, 45, MACHAMP, 45, EXEGGUTOR, 47, KINGLER, 50, ALAKAZAM, 53, CHARIZARD, 0

Rival3Data:
	db $FF, 61, DODRIO, 59, ALAKAZAM, 61, RHYDON, 61, RAPIDASH, 63, JOLTEON, 65, BLASTOISE, 0
	db $FF, 61, DODRIO, 59, ALAKAZAM, 61, RHYDON, 61, TENTACRUEL, 63, FLAREON, 65, VENUSAUR, 0
	db $FF, 61, DODRIO, 59, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, VAPOREON, 65, CHARIZARD, 0
	; marcelnote - new rematch teams
	db $FF, 71, DODRIO, 69, ALAKAZAM, 71, RHYDON, 71, RAPIDASH, 73, JOLTEON, 75, BLASTOISE, 0
	db $FF, 71, DODRIO, 69, ALAKAZAM, 71, RHYDON, 71, TENTACRUEL, 73, FLAREON, 75, VENUSAUR, 0
	db $FF, 71, DODRIO, 69, ALAKAZAM, 71, RHYDON, 71, EXEGGUTOR, 73, VAPOREON, 75, CHARIZARD, 0
...
; Unused
	...
	db $FF, 66, TAUROS, 67, ELECTRODE, 68, CHANSEY, 69, SNORLAX, 70, VENUSAUR, 72, NIDOKING, 0
	db $FF, 66, TAUROS, 67, ELECTRODE, 68, CHANSEY, 69, SNORLAX, 70, CHARIZARD, 72, NIDOKING, 0
	db $FF, 66, TAUROS, 67, ELECTRODE, 68, CHANSEY, 69, SNORLAX, 70, BLASTOISE, 72, NIDOKING, 0
