; marcelnote - new location
	...
	const_export ORANGEFERRYROOMS_BLASTOISE
...
OrangeFerryRooms_Object:
	...
	def_bg_events
	bg_event 31,  8, TEXT_ORANGEFERRYROOMS_CAPTAINS_BOOK
	...
	object_event 34,  7, SPRITE_MONSTER, STAY, DOWN, TEXT_ORANGEFERRYROOMS_BLASTOISE
