...
SaffronCity_Object:
	...
	def_object_events
	;object_event  6,  7, SPRITE_ROCKET, STAY, NONE, TEXT_SAFFRONCITY_ROCKET1
	object_event  7,  7, SPRITE_ROCKET, STAY, NONE, TEXT_SAFFRONCITY_ROCKET1 ; for testing
	...
	object_event 35,  4, SPRITE_ROCKET, STAY, NONE, TEXT_SAFFRONCITY_ROCKET3 ; for testing
	...
	object_event 19, 22, SPRITE_ROCKET, STAY, DOWN, TEXT_SAFFRONCITY_ROCKET8 ; for testing
