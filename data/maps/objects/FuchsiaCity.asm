	...
	const_export FUCHSIACITY_COOLTRAINER_M ; marcelnote - new NPC
...
FuchsiaCity_Object:
	...
	object_event 25,  30, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_FUCHSIACITY_COOLTRAINER_M ; marcelnote - new NPC
	object_event 26,  30, SPRITE_MONSTER, STAY, DOWN, TEXT_FUCHSIACITY_PRIMEAPE ; marcelnote - new NPC
