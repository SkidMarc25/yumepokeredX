;marcelnote - new location
	...
	const_export CINNABARVOLCANO1F_LANCE ; marcelnote - postgame Lance
...
CinnabarVolcano1FB1F_Object:
	...
	object_event 24, 10, SPRITE_LANCE, STAY, NONE, TEXT_CINNABARVOLCANO1F_LANCE ; marcelnote - postgame Lance
