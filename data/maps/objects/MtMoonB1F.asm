MtMoonB1F_Object:
	...
	warp_event 27,  3, ROUTE_4, 3 ; marcelnote - added Mt Moon Square
	warp_event  3, 23, MT_MOON_B2F, 5 ; marcelnote - added Mt Moon Square
	warp_event  1, 27, MT_MOON_SQUARE, 1 ; marcelnote - added Mt Moon Square
