MapSongBanks::
	...
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; CINNABAR_VOLCANO_1F ; marcelnote - new location
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; UNUSED_MAP_6A ; CINNABAR_VOLCANO_2F
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; UNUSED_MAP_6B ; CINNABAR_VOLCANO_B1F
