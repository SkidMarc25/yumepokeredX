WildDataPointers:
	...
	dw NothingWildMons         ; ORANGE_ROUTE_1 ; marcelnote - new location
	...
	dw NothingWildMons                 ; COPYCATS_HOUSE ; marcelnote - merged Copycat's house floors
	...
	dw NothingWildMons                 ; CITRUS_FERRY_DECK            ; marcelnote - new location
	dw NothingWildMons                 ; CITRUS_FERRY_OUTSIDE         ; marcelnote - new location
	dw NothingWildMons                 ; CITRUS_FERRY_ROOMS           ; marcelnote - new location
...
INCLUDE "data/wild/maps/MtSilver2F.asm"           ; marcelnote - new location
