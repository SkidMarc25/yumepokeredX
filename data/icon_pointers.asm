...
MonPartySpritePointers:
	...
	mon_icon_header PikachuSprite,        0, 4, ICON_PIKACHU << 2 ; marcelnote - added Pikachu icon
	...
	mon_icon_header PikachuSprite,       12, 4, ICONOFFSET + ICON_PIKACHU << 2 ; marcelnote - added Pikachu icon
